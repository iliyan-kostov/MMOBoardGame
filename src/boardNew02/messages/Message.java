...
public abstract class Message implements java.io.Serializable {
    ...
    public static enum MESSAGETYPE {
        ...
        LOBBY_GAMESTARTED, // стартирана игра, в която потребителят участва (С -> К)
        LOBBY_GAMESYNC, // синхронизиращо съобщение за игра (С -> К)
        INGAME_MOVEFIGURES, // местене на фигури (К -> С -> К; С -> К)
        INGAME_REMOVEFIGURES, // премахване на фигура от игра (С -> К)
        INGAME_ENDTURN, // край на ход (К -> С -> К; С -> К)
        INGAME_ENDGAME // край на игра (С -> К)
    }
